...
$('.btn-local').on("click", function(){
      ...
      switch(ciudad){
        ...
        case 'cartagena':
          linked = "https://www.google.com/maps/d/u/0/embed?mid=1O6dSdn-6AqXkEnlsVICcuJmxJZZUdwst";
          break;
